...
public class BetterColonyMod extends BaseModPlugin {
    public static float[] USE_RATE = { 0.1464f, 0.1357f, 0.1250f, 0.1143f, 0.1036f, 0.0929f, 0.0821f, 0.0714f, 0.0607f,
            0.0500f };
    ...
    public void onGameLoad(boolean newGame) {
        ...
        if (newGame) {
            ...
            Object memObj = memory.get("$better_colony_mod");
            boolean already_generated = (memObj != null) ? (boolean) memObj : false;
